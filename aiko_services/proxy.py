...
# To Do
# ~~~~~
# - Considering using wrapt (Python module)
#   - https://wrapt.readthedocs.io/en/latest/wrappers.html#custom-object-proxies
#
# - Aspect Oriented Programming ...
#   - Support multiple intercepts per function
#   - Attach intercepts to specified functions
#   - Intercept: remote function call
#   - Intercept: logging (flight recorder)
#   - Intercept: security access
#   - Intercept: timing (performance)

from inspect import isfunction

__all__ = ["Proxy", "ProxyExample"]
